...
def list():
    ...
    hot_resources = Resource.query.order_by(Resource.view_count.desc()).limit(30).all()
    return render_template('resource/list.html', pagination=resources, hot_resources=hot_resources)
